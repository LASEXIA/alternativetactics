...
orchard_plot(m1_fig, mod = "measure1", group = "id", xlab = expression("Hedges’" ~ italic("g")),g = TRUE, flip = FALSE)+
...
orchard_plot(m2, group = "id",xlab= expression("Hedges’" ~ italic("g")),g = TRUE, flip = FALSE) +
  labs(x = "Effect sizes") +
...
orchard_plot(m3_fig, mod = "type_tactics",group="id", xlab =expression("Hedges’" ~ italic("g")),g = TRUE, flip = FALSE) +
  scale_colour_manual(values = c("#808080", "#808080")) +
  scale_fill_manual(values = c("#0a0a0a", "#0a0a0a")) +
  theme_classic() +
  xlab("Expression of AMT") +
  theme(axis.text = element_text(size = 11, colour = "black"),
        axis.title = element_text(size = 13),
        legend.text = element_text(size = 10),
        legend.title = element_text(size = 10),
...
study_fig <- ggplot(data = tactics, aes(x = sei, y = yi)) +
  ...
  labs(x = "Square root of variance (sei)", y = expression("Hedges’" ~ italic("g")), size = "Precision") +
  theme_classic() +
  theme(axis.text = element_text(size = 11, colour = "black"),
        axis.title = element_text(size = 13),
        legend.text = element_text(size = 10),
...
time_fig <- ggplot(data = tactics, aes(x = year, y = yi)) +
  ...
  labs(x = "Year of publication", y = expression("Hedges’" ~ italic("g")), size = "Precision") +
  theme_classic() +
  theme(axis.text = element_text(size = 11, colour = "black"),
        axis.title = element_text(size = 13),
        legend.text = element_text(size = 10),
...
orchard_plot(s1_fig, mod = "comparison", group="id", xlab =expression("Hedges’" ~ italic("g")),g = TRUE, flip = FALSE) +
...
orchard_plot(s2_fig, mod = "comparison2", group="id", xlab =expression("Hedges’" ~ italic("g")),g = TRUE, flip = FALSE) +
...
# Creating a model without intercept in order to build the figure
s3_fig <- rma.mv(yi,vi, mods = ~vertebrate - 1,
                 random=list(~1|sp2,
                             ~1|id,
                             ~1|researcher,
                             ~1|experiment,
...
orchard_plot(s3_fig, mod = "vertebrate",group="id", xlab =expression("Hedges’" ~ italic("g")),g = TRUE, flip = FALSE) +
  scale_colour_manual(values = c("#808080", "#808080", "#808080", "#808080")) +
  scale_fill_manual(values = c("#0a0a0a", "#0a0a0a", "#0a0a0a", "#0a0a0a")) +
  theme_classic() +
  theme(axis.text = element_text(size = 11, colour = "black"),
...
orchard_plot(s4_fig, mod = "family",group="id", xlab =expression("Hedges’" ~ italic("g")),g = TRUE, flip = FALSE) +
...
orchard_plot(s5_fig, mod = "experiment",group="id", xlab =expression("Hedges’" ~ italic("g")),g = TRUE, flip = FALSE) +
  scale_colour_manual(values = c("#808080", "#808080", "#808080", "#808080")) +
  scale_fill_manual(values = c("#0a0a0a", "#0a0a0a", "#0a0a0a", "#0a0a0a")) +
  theme_classic() +
  theme(axis.text = element_text(size = 11, colour = "black"),
...
orchard_plot(s6_fig, mod = "measure_timing",group="id", xlab =expression("Hedges’" ~ italic("g")),g = TRUE, flip = FALSE) +
  scale_colour_manual(values = c("#808080", "#808080", "#808080", "#808080")) +
  scale_fill_manual(values = c("#0a0a0a", "#0a0a0a", "#0a0a0a", "#0a0a0a")) +
  theme_classic() +
  theme(axis.text = element_text(size = 11, colour = "black"),
